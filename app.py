...
age_to_glide_mapping = {
    ...
    '5 months': 'Glidescope Size 0',
    '6 months': 'Glidescope Size 0',
    '7 months': 'Glidescope Size 0',
    '8 months': 'Glidescope Size 0',
    '9 months': 'Glidescope Size 0',
    '10 months': 'Glidescope Size 0',
    '11 months': 'Glidescope Size 0',
    '12 months': 'Glidescope Size 1',
    '1 year': 'Glidescope Size 1',
    '2 years': 'Glidescope Size 1',
    '3 years': 'Glidescope Size 1',
    '4 years': 'Glidescope Size 1',
    '5 years': 'Glidescope Size 1',
    '6 years': 'Glidescope Size 2',
    '7 years': 'Glidescope Size 2',
    '8 years': 'Glidescope Size 2',
    '9 years': 'Glidescope Size 2',
    '10 years': 'Glidescope Size 2',
    '11 years': 'Glidescope Size 2',
    '12 years': 'Glidescope Size 2',
    '13 years': 'Glidescope Size 3',
    '14 years': 'Glidescope Size 3',
    '15 years': 'Glidescope Size 3',
    '16 years': 'Glidescope Size 3',
    '17 years': 'Glidescope Size 3',
    '18 years': 'Glidescope Size 3',
    '19 years': 'Glidescope Size 3',
    '20 years': 'Glidescope Size 3',
    '21 years': 'Glidescope Size 3',
    '22 years': 'Glidescope Size 3',
    '23 years': 'Glidescope Size 3',
    '24 years': 'Glidescope Size 3',
    '25 years': 'Glidescope Size 3'
}
...
age_to_mac_mapping = {
    ...
    '5 months': 'Mac Blade Size 0',
    '6 months': 'Mac Blade Size 0',
    '7 months': 'Mac Blade Size 0',
    '8 months': 'Mac Blade Size 0',
    '9 months': 'Mac Blade Size 0',
    '10 months': 'Mac Blade Size 0',
    '11 months': 'Mac Blade Size 0',
    '12 months': 'Mac Blade Size 1',
    '1 year': 'Mac Blade Size 1',
    '2 years': 'Mac Blade Size 1',
    '3 years': 'Mac Blade Size 1',
    '4 years': 'Mac Blade Size 1',
    '5 years': 'Mac Blade Size 1',
    ...
    '11 years': 'Mac Blade Size 2',
    '12 years': 'Mac Blade Size 2',
...
age_to_miller_mapping = {
    ...
    '6 months': 'Miller Blade Size 0',
    '7 months': 'Miller Blade Size 0',
    '8 months': 'Miller Blade Size 0',
    '9 months': 'Miller Blade Size 0',
    '10 months': 'Miller Blade Size 0',
    '11 months': 'Miller Blade Size 0',
    '12 months': 'Miller Blade Size 1',
    '1 year': 'Miller Blade Size 1',
    '2 years': 'Miller Blade Size 1',
    '3 years': 'Miller Blade Size 1',
    '4 years': 'Miller Blade Size 1',
    '5 years': 'Miller Blade Size 1',
    ...
    '13 years': 'Miller Blade Size 3',
    '14 years': 'Miller Blade Size 3',
    '15 years': 'Miller Blade Size 3',
    '16 years': 'Miller Blade Size 3',
    '17 years': 'Miller Blade Size 3',
    '18 years': 'Miller Blade Size 3',
    '19 years': 'Miller Blade Size 3',
    '20 years': 'Miller Blade Size 3',
    '21 years': 'Miller Blade Size 3',
    '22 years': 'Miller Blade Size 3',
    '23 years': 'Miller Blade Size 3',
    '24 years': 'Miller Blade Size 3',
    '25 years': 'Miller Blade Size 3'
}
...
st.markdown("""
    ...
    3. If you have any questions or issues with the form, please contact the support team at **near4kids_support@xyz.com**.
...
# Intubation Plan Section
    ...
    # Check if 'Other Intubator:' is selected
  ...
  # Load previously saved selection from session state if it exists, otherwise default to an empty list
    ...
    if 'Hypoxemia Refractory to CPAP' in when_intubate:
        ...
        if 'hypoxemia_spo2' in st.session_state:
            hypoxemia_spo2 = st.text_input(
                "If the patient has refractory hypoxemia, please define the SpO2 Level as less than:", 
                value=st.session_state.hypoxemia_spo2  # Use saved SpO2 value as default
            )
        else:
            hypoxemia_spo2 = st.text_input(
                "If the patient has refractory hypoxemia, please define the SpO2 Level as less than:"
    ...
    if 'Other' in when_intubate:
        # Load saved 'other' reason from session state if it exists
        if 'other_when_intubate' in st.session_state:
            other_when_intubate = st.text_input(
                "Please state an 'other' reason for the timing of intubation:", 
                value=st.session_state.other_when_intubate  # Use saved value as default
            )
        else:
            other_when_intubate = st.text_input(
                "Please state an 'other' reason for the timing of intubation:"
    ...
    if 'Other' in advance_airway_provider:
        other_advance_airway_provider = st.text_input("Please state an 'other' Advanced Airway Provider", value=st.session_state.get('other_advance_airway_provider', ""))
    ...
    st.session_state.other_advance_airway_provider = other_advance_airway_provider
    ...
    if 'Other' in advance_airway_procedure:
        other_advance_airway_procedure = st.text_input("Please state an 'other' protocol for Difficult Airway Protocol Initiation", value=st.session_state.get('other_advance_airway_procedure', ""))
        # Append the "Other" input to the selected list if it exists and is not empty
    ...
    st.session_state.other_advance_airway_procedure = other_advance_airway_procedure
